...
public class Structurizr {
    ...
    private static void createWorkspace() throws Exception {
        ...
        SoftwareSystem carShare = model.addSoftwareSystem("Petrol charge sharing system", "Petrol charge sharing system");
        ExternalSystems externalSystems = ContextDiagram.create(workspace, model, carShare);
